...
export const IMG = {
  ...
  fitness: "https://images.unsplash.com/photo-1484704849700-f032a568e944?w=400&h=400&fit=crop&auto=format&q=80",
  speaker: "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop&auto=format&q=80",
  charger: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&h=400&fit=crop&auto=format&q=80",
...
export const inboxMessages = [
  { id: "M1", senderId: "C004", from: "Ruwan Jayawardena", initials: "RJ", subject: "Delivery estimate for ORD-2026-001", snippet: "Hi team — could you confirm whether Galle Road dispatch is still on track for Tuesday?", starred: true, unread: true, labelIds: ["L1"], date: d(0, 9), hasAttachment: false },
  ...
  { id: "M3", senderId: "C007", from: "Malini Rajapaksa", initials: "MR", subject: "Ayurvedic serum — ingredient list", snippet: "Can you share the full INCI list for the face serum batch you shipped last month?", starred: false, unread: false, labelIds: ["L2"], date: d(2, 11), hasAttachment: false },
  ...
  { id: "M5", senderId: "C001", from: "Kasun Perera", initials: "KP", subject: "Return label for ORD-2026-002", snippet: "I've printed the label — should I drop the parcel at your Negombo partner locker?", starred: false, unread: true, labelIds: ["L1", "L2"], date: d(0, 7), hasAttachment: false },
  { id: "M6", senderId: "C005", from: "Dilini Wickramasinghe", initials: "DW", subject: "Leather bag care instructions", snippet: "Do you recommend a specific conditioner for the brass fittings on the messenger bag?", starred: false, unread: false, labelIds: ["L3"], date: d(12, 10), hasAttachment: false },
